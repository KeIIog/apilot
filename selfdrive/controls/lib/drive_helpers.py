...
class VCruiseHelper:
  def __init__(self, CP):
    self.CP = CP
    self.v_cruise_kph = 10 #V_CRUISE_INITIAL
    self.v_cruise_cluster_kph = 10#V_CRUISE_INITIAL
...
def get_lag_adjusted_curvature(CP, v_ego, psis, curvatures, curvature_rates, steerActuatorDelay):
  ...
  safe_desired_curvature = clip(desired_curvature*0.95,     #test keiiog  커브 완만하게 
